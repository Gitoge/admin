...
public class Diplomes implements Serializable {
    ...
    public Diplomes code(String code) {
        this.setCode(code);
        return this;
    }
    ...
    public Diplomes libelle(String libelle) {
    ...
    public Diplomes description(String description) {
    ...
    public Diplomes userIdInsert(Integer userIdInsert) {
    ...
    public Diplomes userdateInsert(LocalDate userdateInsert) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Diplomes)) {
            return false;
        }
        return id != null && id.equals(((Diplomes) o).id);
    }
