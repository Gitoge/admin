...
import com.sn.dtai.admin.service.DepartementService;
...
/**
 * REST controller for managing {@link com.sn.dtai.carriere.domain.Departement}.
 */
@RestController
@RequestMapping("/api")
public class DepartementResource {
    ...
    private static final String ENTITY_NAME = "carriereDepartement";
    ...
    public List<DepartementDTO> getAllDepartement() {
        List<DepartementDTO> departementDTO = departementService.findAllDepartement();
