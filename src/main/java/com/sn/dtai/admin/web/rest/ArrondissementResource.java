...
import com.sn.dtai.admin.service.ArrondissementService;
...
/**
 * REST controller for managing {@link com.sn.dtai.carriere.domain.Arrondissement}.
 */
@RestController
@RequestMapping("/api")
public class ArrondissementResource {
    ...
    private static final String ENTITY_NAME = "carriereArrondissement";
    ...
    public ResponseEntity<ArrondissementDTO> createArrondissement(@Valid @RequestBody ArrondissementDTO arrondissementDTO)
    ...
    public ResponseEntity<ArrondissementDTO> updateArrondissement(
        ...
        @Valid @RequestBody ArrondissementDTO arrondissementDTO
    ) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, arrondissementDTO.getId().toString()))
            .body(result);
    }
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/arrondissements/{id}", consumes = { "application/json", "application/merge-patch+json" })
    public ResponseEntity<ArrondissementDTO> partialUpdateArrondissement(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody ArrondissementDTO arrondissementDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, arrondissementDTO.getId().toString())
        );
    }
    ...
    /**
     * {@code GET  /allArrondissement}
     *
     * @param pageable the pagination information.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list
     *         of agents in body.
     */
    @GetMapping("/allArrondissement")
    public List<ArrondissementDTO> getAllArrondissement() {

        List<ArrondissementDTO> arrondissementDTO = arrondissementService.findAllArrondissement();
