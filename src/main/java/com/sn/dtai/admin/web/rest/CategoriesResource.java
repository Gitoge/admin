...
import com.sn.dtai.admin.repository.CategoriesRepository;
import com.sn.dtai.admin.service.CategoriesService;
...
/**
 * REST controller for managing {@link com.sn.dtai.carriere.domain.Categories}.
 */
@RestController
@RequestMapping("/api")
public class CategoriesResource {
    ...
    private static final String ENTITY_NAME = "carriereCategories";
    ...
    public ResponseEntity<List<CategoriesDTO>> getAllCategories(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
