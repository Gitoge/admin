...
import com.sn.dtai.admin.service.RegionService;
...
/**
 * REST controller for managing {@link com.sn.dtai.carriere.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
    ...
    private static final String ENTITY_NAME = "carriereRegion";
    ...
    public List<RegionDTO> getAllRegion() {
        List<RegionDTO> regionDTO = regionService.findAllRegion();
        return regionDTO;
    }
}
