...
/**
 * A DTO for the {@link com.sn.dtai.admin.domain.Diplomes} entity.
 */
public class DiplomesDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DiplomesDTO)) {
            return false;
        }

        DiplomesDTO diplomesDTO = (DiplomesDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, diplomesDTO.id);
    }
