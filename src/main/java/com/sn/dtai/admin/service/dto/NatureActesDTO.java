...
/**
 * A DTO for the {@link com.sn.dtai.admin.domain.NatureActes} entity.
 */
public class NatureActesDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NatureActesDTO)) {
            return false;
        }

        NatureActesDTO natureActesDTO = (NatureActesDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, natureActesDTO.id);
    }
